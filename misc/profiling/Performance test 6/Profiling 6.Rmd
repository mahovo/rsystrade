...
Compare FP (baseline) against R6 and R7. Essentially testing non-encapsulated (FP, S3, S4, R7) against encapsulated (R6).

See also R7 benchmarks:
https://rconsortium.github.io/OOP-WG/articles/performance.html 
