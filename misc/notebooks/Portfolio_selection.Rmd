...
selected_pf_prices <- as.matrix(top_mcap_prices_df_short[, selected_symbols_ids]) %*% unname(unlist(risk_normalized_weights))

unlist(risk_normalized_weights)
```
