...
/Investering/rsystrade/Notes/rsystrade/Development/Volatility targeting.md
...
Absolute values is also *not* equal to the absolute value of the mean for all values of sd:
```{r}
set.seed(3654)
